...
<div style="max-width: 900px; margin: 0 auto; font-family: Arial, sans-serif;">
    ...
    <section style="background: #f8f8f8; padding: 20px; margin-bottom: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        ...
        <form method="get" action="/jewelry/admin/paymentreport/revenueByDate" style="margin-bottom: 15px; display: flex; align-items: center; gap: 10px; justify-content: center;">
        ...
        <form method="get" action="/jewelry/admin/paymentreport/revenueByMonth" style="margin-bottom: 15px; display: flex; align-items: center; gap: 10px; justify-content: center;">
            <label>Chọn tháng:</label>
            <input type="month" name="month" value="<?= $_GET['month'] ?? date('Y-m') ?>" style="padding:5px 10px; border-radius:4px; border:1px solid #ccc;">
            <button type="submit" style="padding:5px 15px; border:none; background:#36A2EB; color:white; border-radius:4px; cursor:pointer;">Xem</button>
        </form>

        <form method="get" action="/jewelry/admin/paymentreport/revenueByYear" style="display: flex; align-items: center; gap: 10px; justify-content: center;">
    ...
    <section style="background: #f8f8f8; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        ...
        <form method="get" action="/jewelry/admin/paymentreport/topProducts" style="display: flex; align-items: center; gap: 10px; justify-content: center;">
...
<p>
    <a href="/jewelry/admin/admindashboard" 
